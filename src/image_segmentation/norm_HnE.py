...
def norm_HnE(img, Io=240, alpha=1, beta=0.15):
    """Norms given RGB image and returns it, plus the H and E separated
    components. Function taken directly from
    https://github.com/bnsreenu/python_for_microscopists/tree/master/267_processing_whole_slide_images
    ...
    ODhat = OD[
        ~np.any(OD < beta, axis=1)
    ]  # Returns an array where OD values are above beta
